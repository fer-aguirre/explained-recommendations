...
class PromptPackage(PackageService):
  ...
  PROMPT = """Please generate the location in the world of the following story. Only repond with the city and country.
...
if __name__ == "__main__":
  ...
  with Steamship.temporary_workspace() as client:
    ...
    example_story = "A person eats a crepe and the views the wonders of the countryside."
    ...
    print(colored("Compliment:", 'grey'),
          f"{prompt.generate(story=example_story)}\n")
